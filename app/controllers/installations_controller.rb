class InstallationsController < ApplicationController
  ...
  def asterisque text
	...
	# text = "#{text}\<br\/\>\* Prix net\, hors frais notariÃ©s\, d\'enregistrement et de publicitÃ© fonciÃ¨re"
	text = "#{text} \-\-\> \* Prix net\, hors frais notariÃ©s\, d\'enregistrement et de publicitÃ© fonciÃ¨re"
	return text
  end
  ...
  def export_firmware
	...
	if params[:instal_code].nil?
		code_err = 1
		text_err = "L'appel de ce service nÃ©cessite un instal_code"
		...
		code_err = 5
		text_err = "Pas de firmware associÃ© Ã  cette installation"
	else
		code_err = 0
  ...
  def export_immauto_biens
	...
	if params[:code_installation].nil?
		code_err = 1
		text_err = "L'appel de ce service nÃ©cessite un code_installation"
